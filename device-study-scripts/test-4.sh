...
for gw in "${ag[@]}"
do	
	exec_ssh_nohup_cmd $gw $scripts_dir "node gateway.js --topology $topology --gatewayType ag"
...
exec_ssh_nohup_cmd '192.168.1.182' $scripts_dir "node gateway.js --topology $topology --gatewayType g"
